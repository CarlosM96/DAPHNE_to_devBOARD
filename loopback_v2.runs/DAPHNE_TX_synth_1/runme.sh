...
HD_PWD='/home/daphnelme/Desktop/DAPHNE_TEST/2nd/loopback_v2/loopback_v2.runs/DAPHNE_TX_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAPHNE_TX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAPHNE_TX.tcl
