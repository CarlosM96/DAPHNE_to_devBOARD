...
--               /home/daphnelme/Desktop/DAPHNE_TEST/2nd/loopback_v2/loopback_v2.srcs/sources_1/ip/DAPHNE_TX/DAPHNE_TX_sim_netlist.vhdl
-- Design      : DAPHNE_TX
...
entity DAPHNE_TX_DAPHNE_TX_CLOCK_MODULE is
  port (
  ...
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_CLOCK_MODULE : entity is "DAPHNE_TX_CLOCK_MODULE";
end DAPHNE_TX_DAPHNE_TX_CLOCK_MODULE;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_CLOCK_MODULE is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_GT is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_GT : entity is "DAPHNE_TX_GT";
end DAPHNE_TX_DAPHNE_TX_GT;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_GT is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_common is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_common : entity is "DAPHNE_TX_common";
end DAPHNE_TX_DAPHNE_TX_common;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_common is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_common_reset is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_common_reset : entity is "DAPHNE_TX_common_reset";
end DAPHNE_TX_DAPHNE_TX_common_reset;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_common_reset is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_cpll_railing is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_cpll_railing : entity is "DAPHNE_TX_cpll_railing";
end DAPHNE_TX_DAPHNE_TX_cpll_railing;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_cpll_railing is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block_0 : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block_0;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block_0 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block_1 : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block_1;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block_1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block_2 is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block_2 : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block_2;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block_2 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block_3 is
  port (
    data_out : out STD_LOGIC;
    data_in : in STD_LOGIC;
    sysclk_in : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block_3 : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block_3;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block_3 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_sync_block_4 is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_sync_block_4 : entity is "DAPHNE_TX_sync_block";
end DAPHNE_TX_DAPHNE_TX_sync_block_4;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_sync_block_4 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_GT_USRCLK_SOURCE is
  port (
    gt0_tx_mmcm_lock_out : out STD_LOGIC;
    gt0_txusrclk2_out : out STD_LOGIC;
    gt0_txusrclk_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_GT_USRCLK_SOURCE : entity is "DAPHNE_TX_GT_USRCLK_SOURCE";
end DAPHNE_TX_DAPHNE_TX_GT_USRCLK_SOURCE;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_GT_USRCLK_SOURCE is
...
txoutclk_mmcm0_i: entity work.DAPHNE_TX_DAPHNE_TX_CLOCK_MODULE
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_TX_STARTUP_FSM is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_TX_STARTUP_FSM : entity is "DAPHNE_TX_TX_STARTUP_FSM";
end DAPHNE_TX_DAPHNE_TX_TX_STARTUP_FSM;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_TX_STARTUP_FSM is
...
sync_TXRESETDONE: entity work.DAPHNE_TX_DAPHNE_TX_sync_block
     port map (
      data_out => txresetdone_s2,
      gt0_txresetdone_out => gt0_txresetdone_out,
      sysclk_in => sysclk_in
    );
sync_mmcm_lock_reclocked: entity work.DAPHNE_TX_DAPHNE_TX_sync_block_0
     port map (
...
sync_pll0lock: entity work.DAPHNE_TX_DAPHNE_TX_sync_block_1
     port map (
...
sync_run_phase_alignment_int: entity work.DAPHNE_TX_DAPHNE_TX_sync_block_2
     port map (
      CLK1_OUT => CLK1_OUT,
      data_in => run_phase_alignment_int_reg_n_0,
      data_out => run_phase_alignment_int_s2
    );
sync_time_out_wait_bypass: entity work.DAPHNE_TX_DAPHNE_TX_sync_block_3
     port map (
      data_in => time_out_wait_bypass_reg_n_0,
      data_out => time_out_wait_bypass_s2,
      sysclk_in => sysclk_in
    );
sync_tx_fsm_reset_done_int: entity work.DAPHNE_TX_DAPHNE_TX_sync_block_4
     port map (
      CLK1_OUT => CLK1_OUT,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_multi_gt is
  port (
    gt0_drprdy_out : out STD_LOGIC;
    gt0_eyescandataerror_out : out STD_LOGIC;
    gt0_gtptxn_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_multi_gt : entity is "DAPHNE_TX_multi_gt";
end DAPHNE_TX_DAPHNE_TX_multi_gt;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_multi_gt is
begin
gt0_DAPHNE_TX_i: entity work.DAPHNE_TX_DAPHNE_TX_GT
     port map (
      CLK1_OUT => CLK1_OUT,
      CLK_IN => CLK_IN,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_init is
  port (
    gt0_drprdy_out : out STD_LOGIC;
    gt0_eyescandataerror_out : out STD_LOGIC;
    gt0_gtptxn_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_init : entity is "DAPHNE_TX_init";
end DAPHNE_TX_DAPHNE_TX_init;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_init is
  signal gt0_gttxreset_i : STD_LOGIC;
  signal \^gt0_txresetdone_out\ : STD_LOGIC;
  signal gt0_txuserrdy_i : STD_LOGIC;
begin
  gt0_txresetdone_out <= \^gt0_txresetdone_out\;
DAPHNE_TX_i: entity work.DAPHNE_TX_DAPHNE_TX_multi_gt
     port map (
      CLK1_OUT => CLK1_OUT,
      CLK_IN => CLK_IN,
      gt0_dmonitorout_out(14 downto 0) => gt0_dmonitorout_out(14 downto 0),
...
gt0_txresetfsm_i: entity work.DAPHNE_TX_DAPHNE_TX_TX_STARTUP_FSM
     port map (
      CLK1_OUT => CLK1_OUT,
      MMCM_RESET_IN => MMCM_RESET_IN,
      gt0_gttxreset_i => gt0_gttxreset_i,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DAPHNE_TX_DAPHNE_TX_support is
  port (
    soft_reset_tx_in : in STD_LOGIC;
  ...
  attribute DowngradeIPIdentifiedWarnings of DAPHNE_TX_DAPHNE_TX_support : entity is "yes";
  attribute EXAMPLE_SIM_GTRESET_SPEEDUP : string;
  attribute EXAMPLE_SIM_GTRESET_SPEEDUP of DAPHNE_TX_DAPHNE_TX_support : entity is "TRUE";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of DAPHNE_TX_DAPHNE_TX_support : entity is "DAPHNE_TX_support";
  attribute STABLE_CLOCK_PERIOD : integer;
  attribute STABLE_CLOCK_PERIOD of DAPHNE_TX_DAPHNE_TX_support : entity is 10;
end DAPHNE_TX_DAPHNE_TX_support;

architecture STRUCTURE of DAPHNE_TX_DAPHNE_TX_support is
...
begin
  ...
  gt0_txusrclk2_out <= \^gt0_txusrclk2_out\;
  gt0_txusrclk_out <= \^gt0_txusrclk_out\;
DAPHNE_TX_init_i: entity work.DAPHNE_TX_DAPHNE_TX_init
     port map (
...
common0_i: entity work.DAPHNE_TX_DAPHNE_TX_common
     port map (
...
common_reset_i: entity work.DAPHNE_TX_DAPHNE_TX_common_reset
     port map (
...
cpll_railing_pll0_q0_clk0_refclk_i: entity work.DAPHNE_TX_DAPHNE_TX_cpll_railing
     port map (
      Q0_CLK0_GTREFCLK_OUT => q0_clk0_refclk_i,
      cpll_reset_pll0_q0_clk0_refclk_i => cpll_reset_pll0_q0_clk0_refclk_i,
      gt0_pll0pd_t => gt0_pll0pd_t
    );
gt_usrclk_source: entity work.DAPHNE_TX_DAPHNE_TX_GT_USRCLK_SOURCE
     port map (
...
entity DAPHNE_TX is
  ...
  attribute NotValidForBitStream of DAPHNE_TX : entity is true;
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of DAPHNE_TX : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of DAPHNE_TX : entity is "DAPHNE_TX,gtwizard_v3_6_11,{protocol_file=Start_from_scratch}";
end DAPHNE_TX;

architecture STRUCTURE of DAPHNE_TX is
...
begin
inst: entity work.DAPHNE_TX_DAPHNE_TX_support
     port map (
